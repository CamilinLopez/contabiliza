...
export default function Navconsola() {
  return (
    <div className="bg-custom-azul-1 w-full h-full">
      <div className="p-5 h-[40px] w-full flex gap-x-5 items-center">
        <div>
          <Link href={'/consola'}>
        ...
        <div className="relative">
          <input
            type="text"
            className="w-[482px] h-[30px] border-[1px] border-[#879596] bg-[#252527] focus:outline-none focus:border-custom-azul-3 text-white transition duration-300 pl-9"
            placeholder="Buscar"
          />
